...
colnames(APLs)<-c(names(APLs)[1:10], "abbott_s", "pos_abbott_s", "month_abbott_s")
...
```{r}
# create vax% cat var
APLs$vax_cat<-rep(NA, length(APLs$clean_IDe))
...
APLs$vax_est<-rep(0, length(APLs$clean_IDe))
...
p09v0.lab<-c("APL-Abbott (COI=50)", "APL-Abbott (COI=402)",
